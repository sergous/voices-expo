...
import { View, Text, TouchableOpacity, ScrollView, Image, Slider, Dimensions, Animated } from 'react-native';
import { 
  Play, 
  Pause, 
  SkipForward, 
...
const mockTracks = [
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1487954335942-047e6d1551ee?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8Q29uY2VydCUyMG11c2ljJTIwcGVyZm9ybWFuY2V8ZW58MHx8MHx8fDA%3D',
    phrases: [
  ...
  },
  {
    ...
    artist: 'Queen',
    imageUrl: 'https://images.unsplash.com/photo-1542844985-d6ee1fc9b891?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8TXVzaWMlMjBjbGFzcyUyMHBlcmZvcm1hbmNlfGVufDB8fDB8fHww',
    phrases: [
  ...
  },
  {
    ...
    artist: 'Queen',
    imageUrl: 'https://images.unsplash.com/photo-1718947109846-f19c3fe3062e?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fE11c2ljJTIwYmFuZCUyMHBlcmZvcm1hbmNlfGVufDB8fDB8fHww',
    phrases: [
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} className="max-h-24">
            <View className="flex-row gap-3">
              {mockTracks.map((track) => (
                ...
                >
                  <Text className="text-white font-medium text-sm" numberOfLines={1}>{track.title}</Text>
        ...
        <View className="bg-gray-800 rounded-2xl p-6 mb-8">
          ...
          <View className="gap-3">
            <View className="flex-row items-start">
              ...
              <Text className="text-gray-300 ml-3 flex-1">Listen carefully to the original phrase before attempting to repeat it</Text>
            </View>
            <View className="flex-row items-start">
              <View className="bg-green-500 rounded-full w-6 h-6 items-center justify-center mt-1">
                <Text className="text-black text-xs font-bold">2</Text>
              </View>
              <Text className="text-gray-300 ml-3 flex-1">Match the rhythm, pitch, and tone as closely as possible</Text>
            </View>
            <View className="flex-row items-start">
              <View className="bg-green-500 rounded-full w-6 h-6 items-center justify-center mt-1">
                <Text className="text-black text-xs font-bold">3</Text>
              </View>
              <Text className="text-gray-300 ml-3 flex-1">Practice the same phrase multiple times for better results</Text>
            </View>
          </View>
        </View>
      </ScrollView>
