...
import { View, Text, TouchableOpacity, ScrollView, Image, Slider, Dimensions } from 'react-native';
import { Play, Pause, SkipBack, SkipForward, Download, Clock, User, Heart, Share2, Settings } from 'lucide-react-native';
...
const audioContent = {
  ...
  duration: '12:45',
  description: 'Master proper breathing techniques to enhance your vocal performance and maintain consistency during long sessions.',
  ...
  return (
    <View className="flex-1 bg-gray-900">
      ...
      <View className="mt-8 mx-6 p-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl">
        <Text className="text-white text-center font-bold text-lg">Unlock All Premium Content</Text>
        <Text className="text-white text-center mt-2">Subscribe for $50/month to access all courses and podcasts</Text>
