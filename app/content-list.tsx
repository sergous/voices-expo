...
import { View, Text, TextInput, TouchableOpacity, SectionList, Image, StyleSheet, Animated } from 'react-native';
import { Play, Search, Mic, Filter, Lock, Unlock } from 'lucide-react-native';
...
const mockCourses = [
  ...
  },
  {
    ...
    price: 2,
    imageUrl: 'https://images.unsplash.com/photo-1543033906-8f2a9f541af9?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8ZXNwb3J0cyUyMHZpcnR1YWwlMjByYWNpbmclMjBldmVudHxlbnwwfHwwfHx8MA%3D%3D',
    isPurchased: false,
  },
  {
    id: '5',
    ...
    price: 2,
    imageUrl: 'https://images.unsplash.com/photo-1635099404457-91c3d0dade3b?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8MyUyMGdyYXBoaWNzfGVufDB8fDB8fHww',
    isPurchased: false,
  },
  {
    id: '6',
    ...
    price: 2,
    imageUrl: 'https://images.unsplash.com/photo-1675351085230-ab39b2289ff4?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mjh8fDMlMjBncmFwaGljc3xlbnwwfHwwfHx8MA%3D%3D',
    isPurchased: false,
  },
];
...
const ContentListScreen = () => {
  ...
  const renderSectionHeader = ({ section }: { section: any }) => (
    <Text className="text-white text-xl font-bold mt-6 mb-3 px-4">
      {section.title}
    </Text>
  );
