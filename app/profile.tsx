...
const ProfileScreen = () => {
  ...
  const purchaseHistory = [
    { id: 1, title: 'Advanced Vocal Techniques', date: '2023-05-15', amount: '$2.00', type: 'Course' },
    { id: 2, title: 'Monthly Subscription', date: '2023-05-01', amount: '$50.00', type: 'Subscription' },
      ...
      <ScrollView className="flex-1 px-4 py-6">
          ...
          <View className="mt-6 bg-[#1E1E1E] rounded-xl p-4 w-full">
            <View className="flex-row justify-between items-center">
              <View>
                ...
                <Text className={`text-${subscriptionStatus === 'active' ? '[#1ED760]' : '[#FF5C5C]'} text-base font-medium mt-1`}>
            ...
            <Text className="text-[#B3B3B3] text-sm mt-3">
              Renews on June 1, 2023 • $50/month
            </Text>
          </View>
        </View>
        ...
        <View className="mb-8">
          ...
          {purchaseHistory.map((item) => (
            <View key={item.id} className="flex-row justify-between items-center bg-[#1E1E1E] rounded-xl p-4 mb-3">
              <View>
                <Text className="text-white text-base font-medium">{item.title}</Text>
        ...
        {/* Account Management */}
        <View className="mb-8">
          <Text className="text-white text-xl font-bold mb-4">Account Management</Text>
        ...
        <TouchableOpacity 
          ...
          className="flex-row items-center justify-center bg-[#FF5C5C] rounded-xl p-4 mb-8"
        >
