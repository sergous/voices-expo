...
const mockAnalysisResults = {
  ...
  exercise:
    "Try this meeting script: 'Good morning team, today we'll be discussing our quarterly goals and how we can exceed expectations together.' Focus on clear enunciation and confident tone.",
}
