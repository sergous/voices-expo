...
import { Mail, Smartphone, Apple, User, Music, BookOpen, ChevronRight } from 'lucide-react-native';
      ...
      case 0:
        return (
          <Animated.View style={{ opacity: fadeAnim }} className="flex-1">
            <Text className="text-3xl font-bold text-white text-center mb-2">Welcome to Voices</Text>
            <Text className="text-gray-300 text-center mb-10">Learn from the best vocal coaches</Text>
      ...
      case 2:
        return (
          <Animated.View style={{ opacity: fadeAnim }} className="flex-1">
            ...
            <Text className="text-gray-300 text-center mb-10">Select what you're interested in learning</Text>
            ...
            <View className="flex-1">
              ...
              >
                <View className="flex-row items-center">
                  <Music color={selectedGoals.includes('Podcasts') ? '#1ED760' : '#B3B3B3'} size={32} />
                  <Text className={`text-xl font-bold ml-4 ${selectedGoals.includes('Podcasts') ? 'text-white' : 'text-gray-300'}`}>Podcasts</Text>
                </View>
              ...
              >
                <View className="flex-row items-center">
                  <BookOpen color={selectedGoals.includes('Courses') ? '#1ED760' : '#B3B3B3'} size={32} />
                  <Text className={`text-xl font-bold ml-4 ${selectedGoals.includes('Courses') ? 'text-white' : 'text-gray-300'}`}>Courses</Text>
                </View>
              ...
              >
                <View className="flex-row items-center">
                  ...
                  <Text className={`text-xl font-bold ml-4 ${selectedGoals.includes('Both') ? 'text-white' : 'text-gray-300'}`}>Both</Text>
                </View>
    ...
    <View className="flex-1 bg-[#121212] p-6 pt-16">
      ...
      <View className="flex-row justify-between items-center mb-8">
        <TouchableOpacity onPress={handleBack} disabled={currentStep === 0}>
          <Text className={`text-lg ${currentStep === 0 ? 'text-gray-600' : 'text-white'}`}>Back</Text>
        </TouchableOpacity>
